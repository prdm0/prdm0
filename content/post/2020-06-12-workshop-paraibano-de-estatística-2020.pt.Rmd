...
Você poderá companhar a apresentação utilizada no seminário pelo seu navegador clicando [**aqui**](https://prdm0.github.io/palestra_wpbest_2020/#1). O vídeo do seminário encontra-se logo abaixo. Divirta-se:
...
No vídeo, apresento com um pouco mais de detalhes, os benefícios de se aproximar da programação funcional em R, em particular troca, se possível, estruturas de loops pelo uso de um funcional conveniente. No vídeo implemento um problema típico da estatística que é o desenvolvimento de simulações de Monte-Carlo - MC e o mostro como é fácil implementar uma simulação de MC de forma serial e paralela em sistemas Linux/Mac e Windows. Os códigos encontram-se abaixo:
