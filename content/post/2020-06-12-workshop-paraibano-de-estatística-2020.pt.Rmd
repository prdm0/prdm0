...
Após o vídeo, estão os dois códigos apresentados, em que o primeiro faz uso de paralelismo via FORK, disponíveis em sistemas Unix-like - *nix (Linux e Unix) e o segundo disponíveis em *nix e em Windows. São discutidas as vantagens e desvantagens de cada um dos sistemas. Divirta-se:
