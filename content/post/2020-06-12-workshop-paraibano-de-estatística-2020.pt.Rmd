...
Nesse seminário, apresentei os benefícios de nos aproximarmos do [**paradigma de programação funcinal**](https://pt.wikipedia.org/wiki/Programa%C3%A7%C3%A3o_funcional) ao implementarmos nossos códigos em [**R**](https://www.r-project.org/). 
