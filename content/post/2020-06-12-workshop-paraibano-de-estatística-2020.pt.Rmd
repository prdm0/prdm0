...
Aconselho que assistam o vídeo, em que apresento, com um pouco mais de detalhes, os benefícios de se aproximar da programação funcional em R, em particular do uso de funcionais. No vídeo implemento um problema típico da estatística que é o desenvolvimento de simulações de Monte-Carlo - MC. No vídeo mostro como é fácil implementar uma simulação de MC de forma serial e paralela em Linux/Mac e Windows. Os códigos encontram-se abaixo:
